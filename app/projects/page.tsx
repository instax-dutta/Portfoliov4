...
export const metadata: Metadata = {
    ...
    description: "Explore 20 production-ready projects by Sai Dutta Abhishek Dash: Epoxy (LLM proxy), MarkItDownJS (document-to-markdown), Vulscany (AI security scanner), PraharShield (anti-bot), Forensic-Recovery (PowerShell triage), CL-Chat Reborn (P2P chat), and more. Expertise in React, Next.js, Python, TypeScript, ML, Cryptography, and Security Architecture.",
    keywords: [
