    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem", position: 9, item: {
          "@type": "SoftwareApplication", name: "Send-Finder", applicationCategory: "WebApplication", operatingSystem: "Web",
          description: "Benchmarks 23+ community-hosted encrypted file sharing (Send) servers directly from your browser with an interactive 3D globe visualization. Fully zero-knowledge and client-side.",
          url: "https://ssf.sdad.pro", programmingLanguage: ["JavaScript", "Three.js", "Web API"],
        },
      },
      {
